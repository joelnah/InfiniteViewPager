package nah.prayer.loopingvp.view;
...
public class NLoopViewPager extends ViewPager {
    ...
    public NPageAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public NLoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
